 function [ x, u, x_guess, u_guess, lmbd_guess, t_guess ] = FTOCP_bi( x_t , xn_tm1, time, N, Ny,C, P, Qfun, SS, s_f, X, U, E, x_guess, u_guess, lmbd_guess, t_guess, solver)
...
Constraints=[Constraints;
             ...
             y_f == SS*lambda;% Terminal point in the convex hull
             ones(1,length(Qfun))*lambda == 1;
             x(1:2,N+1)==y_f(1:2);
             (1-x(2,N+1)*K)*(y_f(3)-y_f(1))*tan(x(3,N+1))==(y_f(4)-y_f(2))];  % Must be convex combination --> sum to 1
